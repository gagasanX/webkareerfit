// components/assessment/CTRLForm.tsx - FIXED VERSION with Google Vision Integration
...
// CTRL WEIGHTAGE SYSTEM - Based on actual document
...
// ✅ FIXED: Exact weightage mapping from CTRL document
const CTRL_CATEGORY_WEIGHTAGES: CategoryWeightage = {
  clarityAndCareerGoals: [
    { text: "I have a clear vision of the type of job and sector I want to transition into.", weightage: 1 },
    { text: "I understand how my personal values and career aspirations align with my desired new role.", weightage: 2 },
    { text: "I have identified the key factors (e.g., salary, work-life balance, job satisfaction) influencing my career transition decision.", weightage: 3 },
    { text: "I have a concrete plan for how this transition aligns with my long-term professional growth.", weightage: 4 },
    { text: "I can articulate the reasons why I am making this transition and how it benefits my career trajectory.", weightage: 5 }
  ],
  transferableSkillsAndExperience: [
    { text: "I can identify the transferable skills from my current role that are relevant to my desired new position.", weightage: 1 },
    { text: "I have evidence or examples of how I have successfully applied my skills in varied contexts.", weightage: 2 },
    { text: "I can effectively communicate how my past achievements add value to the new role or sector.", weightage: 3 },
    { text: "I understand the gaps between my current expertise and the requirements of my desired position.", weightage: 4 },
    { text: "I am actively working on acquiring or enhancing skills to meet the expectations of the new role.", weightage: 5 }
  ],
  adaptabilityAndLearningAgility: [
    { text: "I am open to learning new tools, technologies, and methods required for the new role or sector.", weightage: 1 },
    { text: "I have demonstrated resilience and flexibility when faced with career challenges or changes in the past.", weightage: 2 },
    { text: "I view this career transition as an opportunity for personal and professional growth.", weightage: 3 },
    { text: "I am comfortable stepping out of my comfort zone to adapt to new work environments.", weightage: 4 },
    { text: "I seek feedback and use it constructively to enhance my performance in new situations.", weightage: 5 }
  ],
  marketAndIndustryUnderstanding: [
    { text: "I have researched the industry or sector I want to transition into, including its trends and demands.", weightage: 1 },
    { text: "I am aware of the challenges and opportunities unique to the new sector.", weightage: 2 },
    { text: "I understand the cultural and operational differences between my current role and the desired sector.", weightage: 3 },
    { text: "I have identified potential employers or opportunities that align with my career transition goals.", weightage: 4 },
    { text: "I have a clear understanding of the qualifications and competencies valued in the target industry.", weightage: 5 }
  ],
  networkingAndRelationshipBuilding: [
    { text: "I have reached out to professionals in the industry I want to transition into for advice and insights.", weightage: 1 },
    { text: "I am actively building connections that can help facilitate my career transition.", weightage: 2 },
    { text: "I participate in industry events, workshops, or online forums relevant to my new career goals.", weightage: 3 },
    { text: "I have a mentor or guide who is familiar with the sector I am targeting for transition.", weightage: 4 },
    { text: "I can articulate my career story and transition goals effectively to new professional contacts.", weightage: 5 }
  ],
  emotionalAndMentalPreparedness: [
    { text: "I am prepared to face potential setbacks or rejections during my career transition journey.", weightage: 1 },
    { text: "I manage stress and uncertainty effectively while navigating career changes.", weightage: 2 },
    { text: "I am confident in my ability to make a positive impression in a new industry or role.", weightage: 3 },
    { text: "I have strategies to overcome self-doubt and maintain motivation during this process.", weightage: 4 },
    { text: "I am prepared to invest the necessary time and effort to succeed in my career transition.", weightage: 5 }
  ],
  applicationAndInterviewPreparedness: [
    { text: "My resume and cover letter are tailored to highlight my suitability for the new role or sector.", weightage: 1 },
    { text: "I can clearly explain my reasons for transitioning and how my background aligns with the target job.", weightage: 2 },
    { text: "I have practiced responding to questions about my career change in a confident and positive manner.", weightage: 3 },
    { text: "I am familiar with the recruitment processes and expectations in the new sector.", weightage: 4 },
    { text: "I have prepared examples of how my skills and experiences demonstrate my readiness for the new role.", weightage: 5 }
  ]
};

// ✅ CTRL Categories in correct order
const CTRL_CATEGORIES = [
  { key: 'clarityAndCareerGoals', title: 'Clarity and Career Goals', description: 'Choose the statement that best describes your career clarity and transition goals.' },
  { key: 'transferableSkillsAndExperience', title: 'Transferable Skills and Experience', description: 'Select the option that reflects your skill transferability and experience relevance.' },
  { key: 'adaptabilityAndLearningAgility', title: 'Adaptability and Learning Agility', description: 'Choose the statement that represents your adaptability and learning approach.' },
  { key: 'marketAndIndustryUnderstanding', title: 'Market and Industry Understanding', description: 'Select the option that best describes your industry knowledge and market awareness.' },
  { key: 'networkingAndRelationshipBuilding', title: 'Networking and Relationship Building', description: 'Choose the statement that reflects your networking capabilities and relationship building.' },
  { key: 'emotionalAndMentalPreparedness', title: 'Emotional and Mental Preparedness', description: 'Select the option that describes your emotional readiness for career transition.' },
  { key: 'applicationAndInterviewPreparedness', title: 'Application and Interview Preparedness', description: 'Choose the statement that represents your job application and interview readiness.' }
];

interface CTRLFormData {
  personalInfo: {
    name: string;
    email: string;
    phone: string;
  ...
  _internalScores: {
    clarityAndCareerGoals: number;
    transferableSkillsAndExperience: number;
    adaptabilityAndLearningAgility: number;
    marketAndIndustryUnderstanding: number;
    networkingAndRelationshipBuilding: number;
    emotionalAndMentalPreparedness: number;
    applicationAndInterviewPreparedness: number;
...
export default function CTRLForm({ assessmentId, assessmentType, onSubmit }: CTRLFormProps) {
  ...
  const [formData, setFormData] = useState<CTRLFormData>({
    personalInfo: {
      name: '',
      email: '',
      phone: '',
    ...
    applicationAndInterviewPreparedness: '',
    _internalScores: {
      clarityAndCareerGoals: 0,
      transferableSkillsAndExperience: 0,
      adaptabilityAndLearningAgility: 0,
      marketAndIndustryUnderstanding: 0,
      networkingAndRelationshipBuilding: 0,
      emotionalAndMentalPreparedness: 0,
      applicationAndInterviewPreparedness: 0,
      rawTotalScore: 0,
      formPercentage: 0,
      formContribution: 0,
  ...
  // ✅ CORRECT CTRL scoring calculation (60% form + 40% resume)
  const calculateCTRLScores = (currentFormData: CTRLFormData) => {
    const categories = ['clarityAndCareerGoals', 'transferableSkillsAndExperience', 'adaptabilityAndLearningAgility', 'marketAndIndustryUnderstanding', 'networkingAndRelationshipBuilding', 'emotionalAndMentalPreparedness', 'applicationAndInterviewPreparedness'] as const;
    let rawTotalScore = 0;
    ...
    categories.forEach(category => {
      ...
      if (selectedAnswer && CTRL_CATEGORY_WEIGHTAGES[category]) {
        const option = CTRL_CATEGORY_WEIGHTAGES[category].find(opt => opt.text === selectedAnswer);
        if (option) {
  ...
  const updateFormData = (section: string, field: string, value: string | string[]) => {
    ...
    const newScores = calculateCTRLScores(updatedData);
  ...
  useEffect(() => {
    ...
    CTRL_CATEGORIES.forEach(category => {
      if (formData[category.key as keyof CTRLFormData]) completedFields++;
    });
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    const missingCategories = CTRL_CATEGORIES.filter(category => 
      !formData[category.key as keyof CTRLFormData]
    );
    ...
    try {
      ...
      const enhancedFormData = {
        ...
        _internalScoring: {
          ...
          categoryScores: {
            clarityAndCareerGoals: formData._internalScores.clarityAndCareerGoals,
            transferableSkillsAndExperience: formData._internalScores.transferableSkillsAndExperience,
            adaptabilityAndLearningAgility: formData._internalScores.adaptabilityAndLearningAgility,
            marketAndIndustryUnderstanding: formData._internalScores.marketAndIndustryUnderstanding,
            networkingAndRelationshipBuilding: formData._internalScores.networkingAndRelationshipBuilding,
            emotionalAndMentalPreparedness: formData._internalScores.emotionalAndMentalPreparedness,
            applicationAndInterviewPreparedness: formData._internalScores.applicationAndInterviewPreparedness
          },
          frontendVersion: '2.0',
          assessmentType: 'CTRL',
      ...
      console.error('❌ CTRL Google Vision submission error:', err);
  ...
  const renderCategoryQuestion = (category: typeof CTRL_CATEGORIES[0]) => {
    const options = CTRL_CATEGORY_WEIGHTAGES[category.key] || [];
    const selectedValue = formData[category.key as keyof CTRLFormData] as string;
  ...
  if (step === 'analyzing') {
    return (
      <AssessmentProcessingScreen 
        assessmentType={(assessmentType || 'ctrl') as AssessmentType}
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                The CTRL evaluates your preparedness to make a significant career shift. It highlights strengths, identifies areas for growth, 
                and provides actionable insights powered by Google Vision AI to ensure a smooth and successful transition.
              </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="personalInfo.jobPosition" className="block text-sm font-medium text-gray-700">
                      Target Job Position (after transition) *
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                      placeholder="e.g.: Data Analyst, UX Designer, Project Manager"
                    />
                  </div>
                ...
                <div className="space-y-8">
                  <div className="border-t pt-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      Answer all questions to receive your comprehensive career transition readiness analysis.
                    </p>
                  </div>
                  
                  {CTRL_CATEGORIES.map(category => renderCategoryQuestion(category))}
                </div>
      ...
      {step === 'preview' && (
        <div className="space-y-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Review Your CTRL Assessment</h2>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  {CTRL_CATEGORIES.map(category => (
                    <div key={category.key} className="border-l-4 border-blue-200 pl-4 py-2">
                      ...
                      <p className="text-sm text-gray-600 mt-1">{formData[category.key as keyof CTRLFormData] as string}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end">
                ...
                <button 
                  ...
                  disabled={isSubmitting}
                >
                  {isSubmitting ? 'Processing...' : 'Submit CTRL Assessment'}
                </button>
              </div>
            </div>
          </div>
